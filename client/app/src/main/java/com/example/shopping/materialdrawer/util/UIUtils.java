package com.example.shopping.materialdrawer.util;
...
public class UIUtils {
    ...
    public static Drawable getPlaceHolder(Context ctx) {
        ...
        return new IconicsDrawable(ctx, GoogleMaterial.Icon.gmd_person).color(textColor).backgroundColorRes(R.color.md_grey_50).iconOffsetYDp(2).paddingDp(2).sizeDp(56);
    }

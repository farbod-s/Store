package com.example.shopping.materialdrawer;
...
import com.example.shopping.materialdrawer.adapter.BaseDrawerAdapter;
import com.example.shopping.materialdrawer.model.interfaces.Badgeable;
import com.example.shopping.materialdrawer.model.interfaces.IDrawerItem;
import com.example.shopping.materialdrawer.model.interfaces.Iconable;
import com.example.shopping.materialdrawer.model.interfaces.Nameable;
import com.example.shopping.materialdrawer.util.KeyboardUtil;
...
public class Drawer {
    ...
    public void updateBadge(String badge, int position) {
        if (mDrawerBuilder.checkDrawerItem(position, false)) {
            ...
            if (drawerItem instanceof Badgeable && Integer.valueOf(badge) > 0) {

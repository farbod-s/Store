...
import com.example.shopping.app.model.Payment;
...
public class PaymentMethodAdapter extends BaseAdapter {
    ...
    public PaymentMethodAdapter(Context context, List<Payment> dataset) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        /*if (i == mLastSelectedPosition) {
            AppController.getInstance().getShoppingCart().mOrder.payment_details = mDataSet.get(i);
        }*/
